...
let audioControlsVisible = true; // default on
let audioMuted = false; // default off
            ...
            submenu: [
                {
                    ...
                    submenu: [
                        {
                            label: i18n._('Insert Audio Loop...'),
                            enabled: callbacks.isFocusedWindow,
                            click: callbacks.insertAudioLoop
                        },
                        {
                            label: i18n._('Audio Effect...'),
                            enabled: callbacks.isFocusedWindow,
                            click: callbacks.insertAudioSFX
                        },
                        {
                            type: 'separator'
                        },
                        {
                            label: i18n._('Show Audio Controls'),
                            type: 'checkbox',
                            checked: audioControlsVisible,
                            click: callbacks.toggleAudioControls
                        },
                        {
                            label: i18n._('Mute Audio'),
                            type: 'checkbox',
                            checked: audioMuted,
                            click: callbacks.toggleAudioMuted
                        },
                        { type: 'separator' },
                        {
                            label: i18n._('Insert Stop All Audio'),
                            enabled: callbacks.isFocusedWindow,
                            click: callbacks.insertAudioStopAll
                        },
                        {
                            label: i18n._('Insert Stop Loop'),
                            enabled: callbacks.isFocusedWindow,
                            click: callbacks.insertAudioStopLoop
                        },
                        {
                            label: i18n._('Insert Stop Effects'),
                            enabled: callbacks.isFocusedWindow,
                            click: callbacks.insertAudioStopOnce
                        }
                    ]
                },
                {
                    ...
                    submenu: [
                        {
                            label: i18n._('Insert Image...'),
                            enabled: callbacks.isFocusedWindow,
                            click: callbacks.insertImage
                        }
                    ]
                }
            ]
...
exports.AppMenus = {
    ...
    setAudioControlsVisible : (e) => audioControlsVisible = (e === undefined ? true : !!e),
    setAudioMuted : (e) => audioMuted = !!e,
